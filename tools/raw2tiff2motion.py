...
# 
# 
#install dependencies: pip3 install numpy rawpy imageio matplotlib memory-profiler opencv-contrib-python  pillow 
...
for (x,y) in zip(headedList, numberList):
    ...
    imageio.imsave('img.'+y+'.tiff', rgb)


# list with viewable filenames
viewableList = ['img.'+str(x)+'.tiff' for x in list(numberList)]
